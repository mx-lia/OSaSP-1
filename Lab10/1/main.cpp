...
bool complex_exp_check(char * word)
{
	...
	typedef std::map<pair<states, char>, states> FST;
	FST wh = {
		{ { initial,'a' },operation },{ { initial,'b' },operation },{ { initial,'(' },obr },
		{ { obr,'a' },operation },{ { obr,'b' },operation },{ { obr,'(' },obr },
		{ { operation,'+' },sign },{ { operation,'-' },sign },{ { operation,'*' },sign },{ { operation,'/' },sign },{ { operation,'^' },sign },{ { operation,'%' },sign },
		{ { operation,')' },cbr },{ { operation,' ' },fin },
		{ { sign,'a' },operation },{ { sign,'b' },operation },{ { sign,'(' },obr },
...
int main() {
	cout << "\"-3.0 \" :" << (fixed_check("-3.0 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"+3.0 \" :" << (fixed_check("+3.0 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"3 \" :" << (fixed_check("3 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"6. \" :" << (fixed_check("6. ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"5.578578 \" :" << (fixed_check("5.578578 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"3.098e-24 \" :" << (float_check("-3.098e-24 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"-3.098 e-24 \" :" << (float_check("-3.098 e-24 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"3 \" :" << (float_check("3 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"6.0 \" :" << (float_check("6.0 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"5e+33 \" :" << (float_check("5e+33 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"5.578578e-1232 \" :" << (float_check("5.578578e-1232 ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"a+b-a*b/a^b%b \" :" << (simple_exp_check("a+b-a*b/a^b%b ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"a++b- \" :" << (simple_exp_check("a++b- ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"(a+b)/(a*b)-(a+(a^b))*(a*((b/a)+(b^a))) \" :" << (complex_exp_check("(a+b)/(a*b)-(a+(a^b))*(a*((b/a)+(b^a))) ") ? "YES" : "NO") << endl << "------\n";
	cout << "\"(a+b)*a) \" :" << (complex_exp_check("(a+b)") ? "YES" : "NO") << endl << "------\n";
	system("pause");
}
